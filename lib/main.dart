...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> _onPrintReceipt() async {
    ...
    await _bluePrintPos.printQR('www.google.com', size: 120);
    ...
    await _bluePrintPos.printReceiptText(receiptSecondText, feedCount: 1,paperSize: PaperSize.mm80,useRaster: true);
  }
}